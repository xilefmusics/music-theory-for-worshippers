...
Now we know why we have our 11 tones. And the key takeaways are, that we have that 11 equdistant tones (officially called semitones), that do fill one octave and do repeat afterwards. They themselves have some color by the fact that they do have overtones/harmonics. And we can use the physics of musical color god created deeply into physics, to create color and therefore beauty with it.
